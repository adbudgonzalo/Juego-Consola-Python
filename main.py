...
def main():
    nombre_jugador = input("¡Bienvenido!, Por favor ingrese su nombre: ")
    ...
    while enemigos:
        ...
        while enemigo_actual.salud > 0:  # Combate mientras el enemigo esté vivo
        ...
        if continuar != "s":
            print("Gracias por haber jugado Batallas!")
            break
